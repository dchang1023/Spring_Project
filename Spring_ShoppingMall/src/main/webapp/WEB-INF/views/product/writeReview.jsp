...
<body>
	<form name="f" action="${pageContext.request.contextPath}/product/addReview">
		<div id="writeReview" align="center">
			...
			상품번호 : ${item_no }<br> <input type="hidden" name="item_no" id="item_no" value="${item_no }">
			작성자 : user01 <br> <input type="hidden" name="id" id="id" value="user01" value="user01">
			제목 : <input type="text" name="review_tit"> <br>
			<textarea name="review_con" rows="10" cols="50" placeholder="리뷰를 남겨주세요."></textarea> <br>
			사진첨부 : <input type="file" name="review_imgfile"> <br><br>
